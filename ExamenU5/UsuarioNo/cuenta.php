...
?>
    ...
    <div id="navegacion" class="d-flex mb-3 ">
        <div class="p-2 "><a id="Link1" class="navbar-brand " href="http://localhost/ExamenU5/UsuarioNo/inicio.php">
                <h5>Tecno-Bookly</h5>
            </a></div>
        <div class="p-2 "><a id="Link2" class="nav-link" href="http://localhost/ExamenU5/UsuarioNo/ListaArticulos.php">
                <h6>Articulos</h6>
            </a></div>
